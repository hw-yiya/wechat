                        ...
                        <div id="tab1" class="tab-pane tab1 in">
                            ...
                            <div class="form-item cf">
                                <div class="form-item cf">
                                    ...
                                    <div class="controls">
                                        <select style="width: 200px;" name="type">
                                            <option value="1" <?php echo $date['type']==1?'selected':'';?>>出租</option>
                                            <option value="2"  <?php echo $date['type']==2?'selected':'';?> >销售</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="controls">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function uploadPicturepath(file, data) {
                                        ...
                                        if (data.status) {
                                            ...
                                            $("#cover_id_path").parent().find('.uidload-img-box').html(
                                ...
                                <div class="form-item cf">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="end_time" class="text time" value="<?php echo ($info["end_time"]); ?>" placeholder="请选择时间" />
                                    </div>
                                </div>
                                <div class="form-item cf">
                                    <label class="item-label">联系人电话</label>
                                    <div class="controls">
                                        <input type="text" class="text input-large" name="phone" value="<?php echo ($date["phone"]); ?>"></div>
                                </div>
                            </div>
                            <div class="form-item cf">
